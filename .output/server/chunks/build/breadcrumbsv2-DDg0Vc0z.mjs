...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "mavrix-breadcrumbs" }, _attrs))} data-v-a50d4589><ul class="flex flex-wrap justify-start items-start text-sm" data-v-a50d4589><li data-v-a50d4589>`);
      ...
      ssrRenderList(crumbs.value, (crumb, index) => {
        _push(`<!--[--><li class="mx-2 text-neutral-400" data-v-a50d4589>`);
        _push(ssrRenderComponent(unref(ChevronsRight), { color: "#c99171" }, null, _parent));
        _push(`</li><li data-v-a50d4589>`);
        if (index < crumbs.value.length - 1) {
          ...
          _push(`<span class="mavrix-text font-semibold text-white pt-2" data-v-a50d4589>${ssrInterpolate(crumb.label)}</span>`);
        }
        _push(`</li><!--]-->`);
      });
      _push(`<!--]--></ul></nav>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/templates/breadcrumbsv2.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const Breadcrumbsv2 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a50d4589"]]);

export { Breadcrumbsv2 as B };
//# sourceMappingURL=breadcrumbsv2-DDg0Vc0z.mjs.map
