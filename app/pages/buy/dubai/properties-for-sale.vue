<template>
  <div class="px-8 py-16">
    ...
    <!-- Listings -->
    <div v-if="loading" class="text-center text-gray-500 py-20">Loading listings...</div>
    ...
    >
        <button
            ...
            class="px-4 py-2 button-mavrix-outline cursor-pointer text-white rounded disabled:opacity-50"
        >
            Previous
        </button>
...
const applyFilters = async (filters: any) => {
  ...
  try {
    ...
    loading.value = false
    currentPage.value = 1 // Reset to page 1 when filters applied
  }
}
...
// 🔹 Computed filtered + paginated listings
