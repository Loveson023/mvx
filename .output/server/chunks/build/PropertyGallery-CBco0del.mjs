import { defineComponent, ref, mergeProps, withCtx, createVNode, computed, watch, unref, createBlock, createCommentVNode, openBlock, Fragment, renderList, renderSlot, useSSRContext } from 'vue';
...
import { _ as _sfc_main$2 } from './Button-DdQxHajf.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex-1 w-full" }, _attrs))} data-v-6c1b2aba>`);
      _push(ssrRenderComponent(_component_UCarousel, {
        ref_key: "carousel",
        ref: carousel,
        items: __props.images,
        ...
        default: withCtx(({ item }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", item)} width="400" height="200" class="rounded-xl w-full object-cover" alt="Property image" data-v-6c1b2aba${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: item,
                ...
                onError: (e) => e.target.src = "/images/mavrix_properties.png",
                alt: "Property image"
              }, null, 40, ["src", "onError"])
            ];
          }
      ...
      _push(`<div class="flex gap-2 justify-center pt-4 flex-wrap" data-v-6c1b2aba><!--[-->`);
      ssrRenderList(__props.images, (img, index) => {
        _push(`<div class="${ssrRenderClass([activeIndex.value === index ? "border-{#AF7554} opacity-100" : "border-transparent opacity-60 hover:opacity-100", "w-16 h-16 rounded-lg overflow-hidden cursor-pointer border-2 transition-all"])}" data-v-6c1b2aba><img${ssrRenderAttr("src", img)} class="object-cover w-full h-full" alt="Thumbnail" data-v-6c1b2aba></div>`);
      });
      _push(`<!--]--></div></div>`);
    };
  }
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/properties/PropertyGallery.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const PropertyGallery = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["__scopeId", "data-v-6c1b2aba"]]), { __name: "PropertiesPropertyGallery" });

export { PropertyGallery as P };
//# sourceMappingURL=PropertyGallery-CBco0del.mjs.map
