import { useSlots, computed, unref, mergeProps, withCtx, createBlock, createCommentVNode, renderSlot, openBlock, createTextVNode, toDisplayString, Fragment, renderList, createVNode, resolveComponent, useSSRContext } from 'vue';
...
import { _ as _sfc_main$3 } from './Button-DdQxHajf.mjs';
...
const _imports_1 = publicAssetsURL("/Scroll.gif");
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_Vueform = resolveComponent("Vueform");
  const _component_StaticElement = resolveComponent("StaticElement");
  const _component_GroupElement = resolveComponent("GroupElement");
  const _component_TextElement = resolveComponent("TextElement");
  const _component_PhoneElement = resolveComponent("PhoneElement");
  const _component_ButtonElement = resolveComponent("ButtonElement");
  _push(`<!--[--><div class="text-center mb-8 max-w-2xl"><h2 class="text-3xl uppercase font-light mb-2">LUXURY LIVING, ONE TAP AWAY </h2><p class="text-gray-400"> Experience seamless access to Dubai’s most prestigious homes — curated, personalized, and ready to explore from the comfort of your phone.</p></div>`);
  _push(ssrRenderComponent(_component_Vueform, {
    size: "md",
    "display-errors": false,
    "validate-on": "step|change",
    class: "max-w-lg mx-auto mavrix-gradient-border px-10 py-10"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_StaticElement, {
          name: "divider",
          tag: "hr"
        }, null, _parent2, _scopeId));
        _push2(ssrRenderComponent(_component_GroupElement, { name: "container" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_TextElement, {
                name: "first_name",
              ...
              return [
                createVNode(_component_TextElement, {
                  name: "first_name",
                  placeholder: "First name",
                  columns: {
                    container: 6,
        ...
        _push2(ssrRenderComponent(_component_PhoneElement, {
          name: "phone",
          placeholder: "Phone",
          rules: [
            "required"
        ...
        _push2(ssrRenderComponent(_component_TextElement, {
          name: "email",
          "input-type": "email",
          rules: [
            "required",
        ...
        _push2(ssrRenderComponent(_component_ButtonElement, {
          name: "register",
          submits: true,
        ...
        return [
          createVNode(_component_StaticElement, {
            name: "divider",
            tag: "hr"
          }),
          createVNode(_component_GroupElement, { name: "container" }, {
            default: withCtx(() => [
              createVNode(_component_TextElement, {
                name: "first_name",
                placeholder: "First name",
          ...
          createVNode(_component_PhoneElement, {
            name: "phone",
            placeholder: "Phone",
            rules: [
              "required"
          ...
          createVNode(_component_ButtonElement, {
            name: "register",
            submits: true,
            "button-label": "SEND INQUIRY",
            full: true,
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/forms/InquiryForm.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const InquiryForm = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]), { __name: "FormsInquiryForm" });

export { InquiryForm as I, _sfc_main$1 as _, _imports_1 as a, _sfc_main$2 as b };
//# sourceMappingURL=InquiryForm-Bs-BTmqv.mjs.map
